...
export default function Home() {
    ...
    const AlertItem = ({ alert, index }: { alert: AlerteDTO, index: number }) => (
        <Animated.View style={[
            styles.alertItem,
            {
                opacity: fadeAnim,
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.statsContainer}>
                    ...
                    <StatCard
                        title="Participation"
                        value={formatPercentage(statistiquesAdmin?.tauxParticipation)}
                        subtitle="Taux moyen"
                        icon="trending-up"
                        color="#FF6B6B"
                    />
                    <StatCard
                        title="Candidats"
                        value={statistiquesAdmin?.totalCandidats}
                ...
                <Animated.View style={[
                    ...
                    {actionsRecentes?.slice(0, 4).map((activite) => (
                        <Animated.View
                            key={activite.id}
                            style={[
                                styles.activityItem,
                        ...
                        >
                            ...
                            <View style={styles.activityContent}>
                                ...
                                <Text style={styles.activityDetails}>{activite.statut}</Text>
                            </View>
                        </Animated.View>
                    ))}
                </Animated.View>
