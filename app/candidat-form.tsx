...
export default function CandidatForm() {
    ...
    const [formData, setFormData] = useState<Partial<CandidatDTO>>({
        username: '',
        email: '',
        description: '',
        photo: '',
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>{isEditMode ? 'Modifier le Candidat' : 'Nouveau Candidat'}</Text>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                <View style={styles.section}>
                    ...
                    <FormField
                        ...
                        placeholder="Courte biographie du candidat"
                        multiline required error={errors.description} icon="document-text-outline"
                    />
                </View>

                <TouchableOpacity style={styles.submitButton} onPress={handleSubmit}>
                    <Text style={styles.submitButtonText}>{isEditMode ? 'Sauvegarder les modifications' : 'Créer le candidat'}</Text>
                </TouchableOpacity>
            </ScrollView>
        </View>
    );
